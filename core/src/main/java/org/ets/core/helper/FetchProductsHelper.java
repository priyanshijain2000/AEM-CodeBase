...
public class FetchProductsHelper {
    ...
    public void getTags(TagManager tagManager, Map<String, String> productMap, ContentElement productElementObject, String tagElement) {
