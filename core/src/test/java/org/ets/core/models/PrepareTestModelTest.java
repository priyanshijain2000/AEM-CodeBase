...
class PrepareTestModelTest {
    ...
    void testDetails() {
        context.currentResource("/content/product-page/jcr:content/preparation-material");
        PrepareTestModel prepareTestModel = context.request().adaptTo(PrepareTestModel.class);
        assertNotNull(prepareTestModel.getDescription());
        assertNotNull(prepareTestModel.getDisableXfTitle());
        assertNotNull(prepareTestModel.getErrorMessage());
        assertNotNull(prepareTestModel.getPageParamsName());
        assertNotNull(prepareTestModel.getPath());
        assertNotNull(prepareTestModel.getPlaceholderText());
        assertNotNull(prepareTestModel.getPrepAriaLabel());       
    }
}
