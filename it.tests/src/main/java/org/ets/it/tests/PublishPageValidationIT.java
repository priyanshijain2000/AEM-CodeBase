...
public class PublishPageValidationIT {
    ...
    public void validateHomepage() throws ClientException, IOException, URISyntaxException {
        ...
        verifyLinkedResources(adminPublish,path);
    		...
    		LOG.error("ClientProtocolException in PublishPageValidationIT class");
    	}
    	catch(IOException e) {
    		LOG.error("IOException in PublishPageValidationIT class");
    	}
    	catch(URISyntaxException e) {
    		LOG.error("URISyntaxException in PublishPageValidationIT class");
    	}
    }
